...
homeIndexArticleListEntityFromJson(HomeIndexArticleListEntity data, Map<String, dynamic> json) {
  ...
  if (json['datas'] != null) {
    data.datas = new List<HomeIndexArticleListData>();
    (json['datas'] as List).forEach((v) {
      data.datas.add(new HomeIndexArticleListData().fromJson(v));
    });
  }
  if (json['offset'] != null) {
...
homeIndexArticleListDataFromJson(HomeIndexArticleListData data, Map<String, dynamic> json) {
  ...
  if (json['tags'] != null) {
    data.tags = new List<HomeIndexArticleListDatasTag>();
    (json['tags'] as List).forEach((v) {
      data.tags.add(new HomeIndexArticleListDatasTag().fromJson(v));
    });
  }
  if (json['title'] != null) {
